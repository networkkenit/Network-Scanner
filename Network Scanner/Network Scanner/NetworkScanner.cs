...
namespace Network_Scanner
{
    public partial class NetworkScanner : Form
    {
        ...
        public void Ping_Device(string host) 
        {
        ...
        private void Ping_Completed(object sender, PingDeviceCompletedEventArgs e)
        {
        ...
        public void Ping_ALL_Devices(string Gateway,bool Autotimeout)
        {
        ...
        private void ping_devices_bgw_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            try
            {
        ...
        private void auto_timeout_btn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.auto_timeout_btn.Image = global::Network_Scanner.Properties.Resources.icons8_schalter_aus_40;
